...
export const TrendingSection: React.FC<TrendingSectionProps> = ({ metal = 'gold' }) => {
  ...
  return (
    <section className="bg-[var(--theme-primary)] dark:bg-surface py-12 md:py-16 select-none border-b border-white/10 dark:border-border/40">
          ...
          {PANELS.map((panel) => (
            <div key={panel.href} className="flex flex-col items-center gap-4">
              ...
              >
                ...
                <ArrowRight className="w-3.5 h-3.5 text-white/75 group-hover:text-[var(--theme-accent-light)] transition-all duration-300 group-hover:translate-x-1" />
              </Link>
