    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-border/40 pb-4 mb-8 gap-4">
        <div>
          ...
          <p className="text-sm font-sans text-gray-500 mt-1">Secure digital storage for your authenticity certificates</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockCertificates.map((cert) => (
          <div key={cert.id} className="bg-white border border-border/60 rounded-xl overflow-hidden hover:border-gold/30 transition-all duration-300 shadow-sm group">
            <div className="aspect-[4/3] bg-gray-100 overflow-hidden relative border-b border-border/40">
              <img 
                src={cert.image} 
                alt={cert.productName} 
                className="w-full h-full object-cover opacity-90 group-hover:scale-105 transition-transform duration-500"
              />
              <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-[10px] font-sans font-bold tracking-widest uppercase flex items-center gap-1.5 shadow-sm">
            ...
            <div className="p-5">
              ...
              <p className="text-sm font-sans text-gray-500 mb-4 flex items-center gap-2">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border/40">
                ...
                <button className="flex items-center gap-2 px-4 py-2 bg-primary text-white text-xs font-sans font-medium rounded hover:bg-primary/90 transition-colors">
