...
export const Notifications: React.FC = () => {
  ...
  const Switch = ({ checked, onChange }: { checked: boolean; onChange: () => void }) => (
    <button 
      onClick={onChange}
      className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors duration-300 focus:outline-none ${checked ? 'bg-gold' : 'bg-gray-200'}`}
    >
      <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition duration-300 ${checked ? 'translate-x-4.5' : 'translate-x-1'}`} />
    </button>
  );
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="border-b border-border/40 pb-4 mb-8">
        ...
        <p className="text-sm font-sans text-gray-500 mt-1">Manage how you receive updates and alerts</p>
      </div>
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-sans text-gray-500 mt-1">Shipping status, delivery confirmations</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-sans text-gray-500 mt-1">Alerts when items in your wishlist go on sale</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-sans text-gray-500 mt-1">Early access to new launches</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-sans text-gray-500 mt-1">Alerts when out of stock items return</p>
            </div>
