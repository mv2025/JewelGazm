    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between border-b border-border/40 pb-4 mb-8">
        <div>
          ...
          <p className="text-sm font-sans text-gray-500 mt-1">Curate your favorite pieces into personalized collections</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="aspect-[16/10] bg-gray-100 overflow-hidden relative">
              ...
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-6">
                <div className="flex items-end justify-between">
                  ...
                  <div className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity translate-x-4 group-hover:translate-x-0 duration-300">
        ...
        <div className="group cursor-pointer relative overflow-hidden rounded-xl border border-border/30 bg-[#FAF8F5] flex flex-col items-center justify-center hover:border-gold/50 transition-all duration-300 min-h-[200px]">
          ...
          <p className="font-sans text-sm text-gray-500 mt-1">View unsorted items</p>
        </div>
      </div>
    </div>
  );
