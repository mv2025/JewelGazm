    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between border-b border-border/40 pb-4 mb-8">
        <div>
          ...
          <p className="text-sm font-sans text-primary/60 mt-1">Save sizes for a seamless checkout experience</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-surface border border-border/60 rounded-xl overflow-hidden shadow-sm">
          <div className="bg-background px-6 py-4 border-b border-border/60 flex items-center justify-between">
            <h3 className="font-serif text-xl text-primary">My Sizes</h3>
            <button className="text-primary/40 hover:text-gold transition-colors">
          ...
          <div className="p-6 space-y-6">
            <div>
              <h4 className="font-sans text-xs font-semibold uppercase tracking-widest text-primary/60 mb-3">Ring Size</h4>
              <div className="flex gap-4">
                <div className="flex-1 bg-surface-hover border border-border/40 rounded-lg p-3 text-center">
                  <p className="text-[10px] uppercase tracking-wider text-primary/40 mb-1">US / Canada</p>
                  <p className="font-serif text-xl text-primary">{mockSizes.user.ring.us}</p>
                </div>
                <div className="flex-1 bg-surface-hover border border-border/40 rounded-lg p-3 text-center">
                  <p className="text-[10px] uppercase tracking-wider text-primary/40 mb-1">UK / AU</p>
                  <p className="font-serif text-xl text-primary">{mockSizes.user.ring.uk}</p>
                </div>
                <div className="flex-1 bg-surface-hover border border-border/40 rounded-lg p-3 text-center">
                  <p className="text-[10px] uppercase tracking-wider text-primary/40 mb-1">EU</p>
            ...
            <div className="pt-4 border-t border-border/30">
              <h4 className="font-sans text-xs font-semibold uppercase tracking-widest text-primary/60 mb-3">Bracelet Size</h4>
              <div className="flex gap-4">
                <div className="flex-1 bg-surface-hover border border-border/40 rounded-lg p-3 text-center">
                  <p className="text-[10px] uppercase tracking-wider text-primary/40 mb-1">CM</p>
                  <p className="font-serif text-xl text-primary">{mockSizes.user.bracelet.cm}</p>
                </div>
                <div className="flex-1 bg-surface-hover border border-border/40 rounded-lg p-3 text-center">
                  <p className="text-[10px] uppercase tracking-wider text-primary/40 mb-1">Inches</p>
        ...
        {/* Partner Sizes */}
        <div className="bg-surface border border-border/60 rounded-xl overflow-hidden shadow-sm relative">
